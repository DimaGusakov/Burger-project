export default function UserIcon() {
  return (
    <svg version="1.1" width="40" height="40" viewBox="0 0 256 256">
      <g style={{
        stroke: "none", 
        strokeWidth: 0, 
